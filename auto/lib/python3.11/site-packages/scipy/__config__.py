...
CONFIG = _cleanup(
    {
        "Compilers": {
            ...
            "pythran": {
                "version": "0.13.1",
                "include directory": r"../../pip-build-env-aaeg2ib1/overlay/lib/python3.11/site-packages/pythran"
            },
        },
        "Machine Information": {
            "host": {
        ...
        "Python Information": {
            "path": r"/private/var/folders/76/zy5ktkns50v6gt5g8r0sf6sc0000gn/T/cibw-run-w1_4nbi0/cp311-macosx_arm64/build/venv/bin/python",
            "version": "3.11",
        },
    }
)
